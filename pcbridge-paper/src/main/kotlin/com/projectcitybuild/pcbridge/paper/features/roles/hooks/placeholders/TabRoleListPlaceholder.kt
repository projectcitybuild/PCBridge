...
class TabRoleListPlaceholder(
    ...
    suspend fun onPlayerStateCreated(event: PlayerStateCreatedEvent) {
        log.debug { "PlayerStateCreatedEvent: updating tab role list for player" }
    ...
    suspend fun onPlayerStateUpdated(event: PlayerStateUpdatedEvent) {
        ...
        log.debug { "PlayerStateUpdatedEvent: updating tab role list for player" }
        update(event.playerUUID)
    }
