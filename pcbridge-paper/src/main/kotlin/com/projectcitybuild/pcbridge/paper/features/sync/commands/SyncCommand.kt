...
class SyncCommand(
    ...
    private suspend fun syncSelf(context: PaperCommandContext) = context.catchSuspending {
    ...
    private suspend fun syncOther(context: PaperCommandContext) = context.catchSuspending {
