package com.projectcitybuild.pcbridge.paper.features.warps.hooks.dialogs
...
class WarpRenameDialog {
    companion object {
        val newNameKey = "new_name"
        val idKey = "id"
        val saveButtonKey = Key.key("pcbridge:dialogs/warp_rename/save")
        ...
        fun build(
            ...
            builder.empty()
                .base(
                    DialogBase.builder(Component.text("Rename Warp"))
        ...
        private val verifyButton get() = ActionButton.create(
            Component.text("Save"),
            Component.text("Click to rename the warp"),
            100,
